 ...
 * <ul>
 *   <li>{@link analysismetamodel.impl.DefaultValueImpl#getComponentInstance <em>Component Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class DefaultValueImpl extends MinimalEObjectImpl.Container implements DefaultValue {
	/**
	...
	protected EClass eStaticClass() {
		return AnalysismetamodelPackage.Literals.DEFAULT_VALUE;
	}
		...
		if (componentInstance != null && componentInstance.eIsProxy()) {
			...
			if (componentInstance != oldComponentInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AnalysismetamodelPackage.DEFAULT_VALUE__COMPONENT_INSTANCE, oldComponentInstance, componentInstance));
			}
		}
	...
	public void setComponentInstance(ComponentInstance newComponentInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalysismetamodelPackage.DEFAULT_VALUE__COMPONENT_INSTANCE, oldComponentInstance, componentInstance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AnalysismetamodelPackage.DEFAULT_VALUE__COMPONENT_INSTANCE:
